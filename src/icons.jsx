// Kompaktes Inline-Icon-Set (Lucide-Stil, stroke-basiert)
const P = {
  ...
  bottle: <><path d="M15.2 22H8.8a2 2 0 0 1-2-1.79L5 3h14l-1.81 17.21A2 2 0 0 1 15.2 22Z"/><path d="M6 12a5 5 0 0 1 6 0 5 5 0 0 0 6 0"/></>,
  snack: <><path d="M12 2a10 10 0 1 0 10 10 4 4 0 0 1-5-5 4 4 0 0 1-5-5"/><circle cx="8.5" cy="8.5" r=".5"/><circle cx="16" cy="15.5" r=".5"/><circle cx="12" cy="12" r=".5"/></>,
  ...
  bus: <><path d="M4 6h16v10a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2z"/><path d="M4 11h16M8 18v2M16 18v2"/><circle cx="8" cy="14.5" r=".5"/><circle cx="16" cy="14.5" r=".5"/></>,
  ...
  cocktail: <path d="M8 22h8M12 11v11M19 3l-7 8-7-8Z"/>,
  install: <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5 5 5-5M12 15V3"/>,
  wallet: <><rect x="2" y="6" width="20" height="14" rx="3"/><path d="M16 12h4M2 10h20"/></>,
}
